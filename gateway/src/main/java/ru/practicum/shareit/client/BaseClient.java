...
public class BaseClient {
    ...
    private <T> ResponseEntity<Object> makeAndSendRequest(HttpMethod method, String path, Long userId, Map<String, Object> parameters, T body) {
        HttpEntity<T> requestEntity = new HttpEntity<>(body, userId != null ? getHeaders(userId) : getHeaders());
